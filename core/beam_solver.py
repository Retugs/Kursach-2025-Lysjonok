...
class BeamSolver:
    ...
    def calculate_moments(self, loads, num_points=100):
    ...
    def calculate_deflections_test(self, loads, num_points=100):
    ...
    def calculate_transverse_forces(self, forces, num_points=100):
